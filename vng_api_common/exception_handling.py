...
def register_exception_handler(
    ...
    * must return a DRF ``Response``
    ...
    .. code-block:: python
        ...
        from vng_api_common.register_exception_handling import register_exception_handler


        class ZaakLockedError(APIException):
            status_code = 409
    ...
    * Custom exceptions should inherit from DRF's ``APIException`` so that the
      shared finalization logic preserves status codes and error details.

...
def get_thread_local_base_url(view_name):
    return getattr(_thread_locals, view_name, None)


def set_thread_local_base_url(url, view_name):
    setattr(_thread_locals, view_name, url)
